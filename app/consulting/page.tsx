    ...
    <div style={styles.page}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.gridFour}>
          ...
          <div style={styles.card}>
            ...
            <p style={styles.cardText}>
              Technical-commercial framing for diligence, opportunity
          ...
          <div style={styles.card}>
            ...
            <p style={styles.cardText}>
              Advisory that strengthens technical workstreams with commercial
      ...
      <section style={styles.section}>
        <div style={styles.sectionIntro}>
          ...
          <h2 style={styles.sectionTitle}>
            Advisory built for complex projects, capital decisions, and
      ...
      <section style={styles.section}>
        <div style={styles.sectionIntro}>
          ...
          <h2 style={styles.sectionTitle}>
            Sector-facing expertise across subsurface, development, and
            transition strategy.
          </h2>
        </div>
...
const styles = {
  ...
  heroGlow: {
    ...
    height: "320px",
    background:
      "radial-gradient(circle, rgba(245,185,66,0.12), transparent 70%)",
